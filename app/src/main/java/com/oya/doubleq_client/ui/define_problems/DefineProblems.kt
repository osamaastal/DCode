package com.oya.doubleq_client.ui.define_problems;
...
import com.oya.doubleq_client.databinding.FragmentDefineProblemBinding
import com.oya.doubleq_client.ui.a_other.OtherActivity

class DefineProblems : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentDefineProblemBinding
    ...
    //view model
//    private lateinit var viewModel: DefineProblemsViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_define_problem, container, false)
...
//        ).get(DefineProblemsViewModel::class.java)
    }
