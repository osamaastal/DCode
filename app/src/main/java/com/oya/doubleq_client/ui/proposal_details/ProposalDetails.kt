package com.oya.doubleq_client.ui.proposal_details;
...
import com.oya.doubleq_client.databinding.FragmentProposalDetailsBinding
import com.oya.doubleq_client.data.api.base.ViewModelFactory
import com.oya.doubleq_client.ui.a_other.OtherActivity

class ProposalDetails : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentProposalDetailsBinding
    ...
    //view model
//    private lateinit var viewModel: ProposalDetailsViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_proposal_details, container, false)
...
//        ).get(ProposalDetailsViewModel::class.java)
    }
