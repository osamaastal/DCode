...
import com.oya.doubleq_client.databinding.FragmentOrderDetailsProductBinding
import com.oya.doubleq_client.data.api.base.ViewModelFactory
import com.oya.doubleq_client.ui.a_other.OtherActivity

class OrderDetailsProduct : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentOrderDetailsProductBinding
    ...
    //view model
//    private lateinit var viewModel: OrderDetailsProductViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_order_details_product, container, false)
...
//        ).get(OrderDetailsProductViewModel::class.java)
    }
