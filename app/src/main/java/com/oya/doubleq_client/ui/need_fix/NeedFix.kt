package com.oya.doubleq_client.ui.need_fix;
...
import com.oya.doubleq_client.databinding.FragmentNeedFixBinding
import com.oya.doubleq_client.data.api.base.ViewModelFactory
import com.oya.doubleq_client.ui.a_other.OtherActivity

class NeedFix : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentNeedFixBinding
    ...
    //view model
//    private lateinit var viewModel: NeedFixViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_need_fix, container, false)
...
//        ).get(NeedFixViewModel::class.java)
    }
