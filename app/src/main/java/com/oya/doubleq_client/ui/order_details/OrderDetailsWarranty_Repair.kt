...
import com.oya.doubleq_client.databinding.FragmentOrderDetailsWarrantyRepairBinding
import com.oya.doubleq_client.ui.a_other.OtherActivity

class OrderDetailsWarranty_Repair : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentOrderDetailsWarrantyRepairBinding
    ...
    //view model
//    private lateinit var viewModel: OrderDetailsRepairViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_order_details_warranty_repair, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            OrderDetailsWarranty_Repair().apply {
...
//        ).get(OrderDetailsRepairViewModel::class.java)
    }
